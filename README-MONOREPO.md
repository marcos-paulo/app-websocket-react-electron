...
│   │   └── index.ts
│   └── package.json          # @websocket-app/shared-types
│
...
- **SHARED** (cyan): Watch mode para shared-types
...
✅ **Tipos compartilhados** - `@websocket-app/shared-types` sincronizado automaticamente  
...
npm install axios --workspace=frontend-redux
...
- ✅ Usa tipos de `@websocket-app/shared-types`
